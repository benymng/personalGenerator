    ...
    <section className="container px-4 mx-auto pt-10">
      <div className="sm:flex sm:items-center sm:justify-between">
        <div>
          <div className="flex items-center gap-x-3">
            <h2 className="text-lg font-medium text-gray-800">Job List</h2>

            <span className="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full">240 jobs</span>
          </div>

          <p className="mt-1 text-sm text-gray-500 text-left ">Jobs you are interested in</p>
        </div>
      ...
      <div className="mt-6 sm:flex sm:items-center sm:justify-between ">
        <div className="text-sm text-gray-500">
          Page <span className="font-medium text-gray-700">1 of {pageCount}</span>
        </div>
