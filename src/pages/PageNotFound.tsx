        ...
        <div class="container flex items-center justify-center min-h-screen px-6 py-12 mx-auto">
          <div class="w-full ">
            <div class="flex flex-col items-center max-w-lg mx-auto text-center">
              <p class="text-sm font-medium text-primary-color">404 error</p>
              <h1 class="mt-3 text-2xl font-semibold text-gray-800 md:text-3xl">We lost this page</h1>
              ...
              <div class="flex items-center w-full mt-6 gap-x-3 shrink-0 sm:w-auto">
                <a href="/">
                  <button class="w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-primary-color rounded-lg shrink-0 sm:w-auto hover:bg-blue-600">
                    Take me home
                  </button>
                </a>
              </div>
            ...
            <div class="grid w-full max-w-6xl grid-cols-1 gap-8 mx-auto mt-8 sm:grid-cols-2 lg:grid-cols-3">
              <div class="p-6 rounded-lg bg-blue-50">
                ...
                <h3 class="mt-6 font-medium text-gray-700 ">Documentation</h3>

                <p class="mt-2 text-gray-500 ">Dive in to learn all about our product.</p>

                <a href="#" class="inline-flex items-center mt-4 text-sm text-primary-color gap-x-2 hover:underline">
