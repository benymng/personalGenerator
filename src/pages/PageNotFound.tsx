        ...
        <div className="container flex items-center justify-center min-h-screen px-6 py-12 mx-auto">
          <div className="w-full">
            <div className="flex flex-col items-center max-w-lg mx-auto text-center">
              <p className="text-sm font-medium text-primary-color">404 error</p>
              ...
              <div className="flex items-center w-full mt-6 gap-x-3 shrink-0 sm:w-auto">
                <a href="/">
                  <button className="w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-primary-color rounded-lg shrink-0 sm:w-auto hover:bg-blue-600">
                    Take me home
                  </button>
                </a>
              </div>
            ...
            <div className="grid w-full max-w-6xl grid-cols-1 gap-8 mx-auto mt-8 sm:grid-cols-2 lg:grid-cols-3">
              <div className="p-6 rounded-lg bg-blue-50">
                ...
                <a href="#" className="inline-flex items-center mt-4 text-sm text-primary-color gap-x-2 hover:underline">
              ...
              <div className="p-6 rounded-lg bg-blue-50">
                ...
                <p className="mt-2 text-gray-500">Can’t find what you’re looking for?</p>
